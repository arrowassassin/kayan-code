import{Rt as e,gt as t,yt as n}from"./charts-C-mlvrj8.js";import{n as r}from"./mermaid-parser.core-CmRZW7ja.js";import{n as i}from"./chunk-Y2CYZVJY-DsF7k-Jl.js";import{t as a}from"./src-8Hwx_Lwn.js";import{H as o,K as s,U as c,a as l,c as u,f as d,v as f,w as p,x as m,y as h}from"./chunk-I66GZJ75-6B1qCttz.js";import{t as g}from"./chunk-JWPE2WC7-DVXcaiue.js";import{i as _,p as v}from"./chunk-NSK5VX7P-C9n9DXBV.js";import{a as y}from"./Mermaid-DyOotji5.js";var b=d.pie,x={sections:new Map,showData:!1,config:b},S=x.sections,C=x.showData,w=structuredClone(b),T={getConfig:i(()=>structuredClone(w),`getConfig`),clear:i(()=>{S=new Map,C=x.showData,l()},`clear`),setDiagramTitle:s,getDiagramTitle:p,setAccTitle:c,getAccTitle:h,setAccDescription:o,getAccDescription:f,addSection:i(({label:e,value:t})=>{if(t<0)throw Error(`"${e}" has invalid value: ${t}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);S.has(e)||(S.set(e,t),a.debug(`added new section: ${e}, with value: ${t}`))},`addSection`),getSections:i(()=>S,`getSections`),setShowData:i(e=>{C=e},`setShowData`),getShowData:i(()=>C,`getShowData`)},E=i((e,t)=>{g(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),D={parse:i(async e=>{let t=await r(`pie`,e);a.debug(t),E(t,T)},`parse`)},O=i(e=>`
  .pieCircle{
